...
export default function Feedback() {
  ...
  return (
    <div
      className={`${
        isLoaded ? "slide-in" : ""
      } w-full flex justify-center items-center mt-20 p-5 gap-24 md-max:gap-5 sm-max:flex-col sm-max:p-2 transition-all`}
    >
      ...
      >
        <div className="w-full flex flex-col justify-center border border-slate-200 gap-2 rounded-xl p-5 text-sm">
          ...
          <input
            ...
            className="bg-slate-100 text-xl text-slate-600 placeholder:text-slate-500 placeholder:opacity-50 border-2 border-slate-200 resize-none outline-none rounded-lg p-2 duration-300 hover:border-green-500"
          />
          ...
          <textarea
            ...
            required
            onChange={handleInputChange}
            className="h-24 bg-slate-100 text-xl text-slate-600 placeholder:text-slate-600 placeholder:opacity-50 border-2 border-slate-200 resize-none outline-none rounded-lg p-2 duration-300 hover:border-green-500"
          ></textarea>
          ...
          >
            <span className="pr-2 text-xl text-green-500 font-bold rounded-lg group-hover:text-white">Submit</span>
        ...
        {isSent && (
          <p className="w-full text-xl text-green-500 absolute bottom-[-30px] left-1/2 transform -translate-x-1/2 flex justify-center border">
